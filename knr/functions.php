...
//wp_enqueue_style( 'knr-google-fonts', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,700italic,400,700,300', false ); 
		...
		if ( 'off' !== _x( 'on', 'Russo One font: on or off', 'knr' ) ) {
			$fonts[] = 'Russo One:400';
		}
...
function knr_scripts() {
	...
	wp_enqueue_style( 'knr-main', get_template_directory_uri().'/css/main.php?theme_color='. get_theme_mod( 'knr_global_color', 'cc3300' ) );	
